...
const TransparencyRating: Lists = {
  TransparencyRating: list({
    graphql: {
      cacheHint: {
        maxAge: 3 * 60 * 60,
    ...
    fields: {
      ...
      project: relationship({ ref: 'Project.transparencyRatings', db: { foreignKey: true } }),
...
export default TransparencyRating;
